...
public class MyQRCapture implements SurfaceHolder.Callback {
    ...
    public MyQRCapture(Activity context, AQuery aq) {
    ...
    public void onResume() {
        ...
        if (viewfinderView == null) {
            viewfinderView = (ViewfinderView) aq.id(R.id.viewfinder_view).getView();
        ...
        if (surfaceView == null)
            surfaceView = (SurfaceView) aq.id(R.id.preview_view).getView();
    ...
    public void onPause() {
        ...
        if (!hasSurface) {
            SurfaceView surfaceView = (SurfaceView) aq.id(R.id.preview_view).getView();
            SurfaceHolder surfaceHolder = surfaceView.getHolder();
