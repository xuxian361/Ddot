...
public class ShareControl {
    ...
    public static void shareWithEmail(Activity context, ArrayList<String> emailtos, HashMap<String, String> data) {
        mContext = context;
        try {
            String[] receiver = new String[0];
            if (emailtos != null) {
                receiver = new String[emailtos.size()];
                for (int i = 0; i < emailtos.size(); i++) {
                    receiver[i] = (String) emailtos.get(i);
                }
            }
